...
export class Backend implements backendInterface {
    ...
    async logPayout(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.logPayout(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async logPokecoinBalance(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.logPokecoinBalance(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async logPokemon(arg0: string, arg1: boolean, arg2: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async searchShinyFemalePokemon(arg0: string): Promise<Array<Pokemon>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchShinyFemalePokemon(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async viewPayouts(): Promise<Array<Payout>> {
        if (this.processError) {
            try {
                const result = await this.actor.viewPayouts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async viewPokecoinBalance(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.viewPokecoinBalance();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
